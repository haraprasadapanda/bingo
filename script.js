...
var Bingo = function(bingoBoardElement, speechInstance) {
    ...
    function generateBingoBoard() {
        ...
        for(var i = 0; i < bingoLetters.length; i++){
            ...
            currentBingoBall = add18Balls(allBingoNumbers, currentBingoBall, letterBlock, bingoLetters[i]);
        }
    }
    /**
     ...
     * @returns {*}
     */
    function add18Balls(allBingoNumbers, currentBingoBall, letterBlock, letter) {
        var totalBingoBalls = currentBingoBall + 18;
    ...
    function resumeGameListener(){
        ...
        if(parseInt(document.getElementById('range').value) ===21) {
    ...
    function callBingoBall() {
        ...
        if(bingoInstance.calledBingoNumbers.length === 90){
